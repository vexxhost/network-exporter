...
var deviceExpected = `
# HELP network_device_boot_timestamp Network device boot timestamp
# TYPE network_device_boot_timestamp gauge
network_device_boot_timestamp{device="fake-dev"} 1.35954034e+08
